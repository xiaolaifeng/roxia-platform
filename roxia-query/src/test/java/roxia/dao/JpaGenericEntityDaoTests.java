...
@ContextConfiguration(locations={"classpath*:roxia-service-*.xml",
		"classpath*:roxia-jpa-*.xml",
		"classpath*:roxia-test-jpa-*.xml",
		"classpath*:roxia-test-dynamic-*.xml"})
public class JpaGenericEntityDaoTests extends AbstractTestNGSpringContextTests {
	...
	public void testUserDaoAdd(){
		...
		user.setPassword("roxia");
		user.setUserName("roxia User");
		userDao.save(user);
