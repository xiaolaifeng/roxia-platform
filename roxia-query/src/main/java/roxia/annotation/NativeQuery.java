...
import roxia.dao.Page;
import roxia.dao.Pagination;
import roxia.dao.Sort;
import roxia.dao.support.DummyColumnTranslator;
import roxia.dao.support.JpaEntityColumnTranslator;
import roxia.dao.support.UpperCaseColumnTranslator;
 ...
 * 如果返回对象类型只是一个Pojo，可以通过在Pojo中使用{@link roxia.annotation.Column}标注属性（标注在getter方法上），然后通过设置<code>model</code>属性完成结果集和对象的绑定。<br/>
